...
name: resume-skills
description: >
  专项优化简历中的技能/技术栈/核心能力模块。用户说"技能怎么写"、
  "技术栈怎么写"、"技能模块太空了"、"技能写太多了不知道怎么取舍"、
  "帮我整理技能"、"证书/语言技能怎么放"、"技能和经历不对应"、
  "前端技能怎么排序"、"AI技能怎么写"时触发。
  覆盖技术岗（前端/后端/AI/全栈/算法）和非技术岗（运营/广告/设计/产品/HR/财务）。
---
...
技能模块是「快速筛选」入口——HR 扫一眼判断你是否符合基本条件。
写好的标准：**相关、具体、有深度、与经历呼应。**

最常见的两个错误：
1. 写了一堆工具名词，像购物清单，没有深度
2. 写了很多技能，但项目经历里完全没有用到
...
1. **与 JD 要求最匹配的放最前**
2. **你最擅长的放前面**（面试官会优先问前几条）
3. **证书 / 语言** 放最后（除非是岗位必须项）
4. 每一类技能别超过 5-6 项，宁缺毋滥
